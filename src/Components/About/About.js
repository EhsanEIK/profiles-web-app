...
const About = () => {
    return (
        <section className='container md:mx-auto mx-5 md:w-[75rem] w-[350px] h-auto bg-white absolute lg:left-[5.25rem] lg:top-[23.938rem] md:left-[2rem] md:top-[15rem] top-[10rem] border-[1px] border-[#D0D0D0] rounded-[10px]'>
            {/* part-01 */}
            <div className='md:flex grid grid-cols-5 mt-[2rem] md:mx-[2.5rem] mx-[1.5rem]'>
                ...
                <div className='md:flex col-span-4 md:ml-[2.5rem] ml-[1rem]'>
                    ...
                    <div className='flex justify-center md:ml-24 md:mt-0 mt-5'>
                        <button className='flex items-center border-[0.063rem] border-[#B4B4B4] rounded-[10px] md:w-[7.5rem] md:h-[3.5rem] w-24 h-full md:py-4 md:px-5 py-2 px-4'>
